...
def page_download(page_id):
    ...
    information_from_page = [page_name, page_id, mobile_phone, site]
    time.sleep(0.5)
    return information_from_page

# Основной код
for group_id in group_ids:
    group_info = vk_download('groups.getById', 'group_ids=' + group_id)
